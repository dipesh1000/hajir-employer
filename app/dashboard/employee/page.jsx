...
const Page = () => {
  ...
  return (
    <div className="flex flex-wrap">
      <Button asChild>
        <Link href="/dashboard/employee/createEmployee">
          {" "}
          Create A Employee
        </Link>
      </Button>
          ...
          {[1, 2].map((tabNumber) => (
            ...
            >
              <a
                ...
                role="tab"
              >
                {tabNumber === 1 ? "Active Employee" : "Inactive Employee"}
              </a>
            </li>
          ))}
        </ul>
          ...
          <div className="px-4 py-5 flex-auto">
            {[1, 2].map((tabNumber) => (
              ...
              >
                {tabNumber === 1 && (
                  <>
                    <p>Information about the active Employee goes here.</p>
                ...
                {tabNumber === 2 && (
                  <p>
                    Information about the inactive Employee goes here.
